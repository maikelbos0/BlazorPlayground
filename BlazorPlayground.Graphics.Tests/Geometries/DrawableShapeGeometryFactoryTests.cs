...
public class DrawableShapeGeometryFactoryTests {
    ...
    public void GetGeometryFromMultiplePolygons() {
        var geometryFactory = new GeometryFactory(new PrecisionModel(1000));
        var subject = new DrawableShapeGeometryFactory(geometryFactory);
        var shapes = new DrawableShape[] {
            new Rectangle(new(-10, -10), new(50, -30)),
            new Rectangle(new(100, 70), new(120, 50))
        };

        var result = subject.GetGeometry(shapes);

        Assert.NotNull(result);
        Assert.Equal(geometryFactory.CreateMultiPolygon([
            geometryFactory.CreatePolygon([new(-10, -10), new(-10, -30), new(50, -30), new(50, -10), new(-10, -10)]),
            geometryFactory.CreatePolygon([new(100, 70), new(100, 50), new(120, 50), new(120, 70), new(100, 70)])
        ]), result);
    }

    [Fact]
    public void GetGeometryFromMultipleLineStrings() {
        var geometryFactory = new GeometryFactory(new PrecisionModel(1000));
        var subject = new DrawableShapeGeometryFactory(geometryFactory);
        var shapes = new DrawableShape[] {
            new Line(new(30, 50), new(50, 100)),
            new Line(new(100, 70), new(120, 50))
        };

        var result = subject.GetGeometry(shapes);

        Assert.NotNull(result);
        Assert.Equal(geometryFactory.CreateMultiLineString([
            geometryFactory.CreateLineString([new(30, 50), new(50, 100)]),
            geometryFactory.CreateLineString([new(100, 70), new(120, 50)])
        ]), result);
    }

    [Fact]
    public void GetGeometryFromMultipleDrawableShapes() {
        var geometryFactory = new GeometryFactory(new PrecisionModel(1000));
        var subject = new DrawableShapeGeometryFactory(geometryFactory);
        var shapes = new DrawableShape[] {
            new Rectangle(new(-10, -10), new(50, -30)),
        ...
        Assert.NotNull(result);
        Assert.Equal(GeometryCombiner.Combine([
            geometryFactory.CreatePolygon([new(-10, -10), new(-10, -30), new(50, -30), new(50, -10), new(-10, -10)]),
            geometryFactory.CreateLineString([new(100, 70), new(120, 50)])
        ]), result);
    }
